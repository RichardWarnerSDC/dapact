...
class ZoomerPaneTest extends ApplicationTest {
    ...
    @Test
    void scaledRectangleShouldEqualRectangleScaled() {
    	Rectangle a = new Rectangle(0, 0, 10, 10);
    	Rectangle b = new Rectangle(0, 0, 20, 20);
    	Scale oldScale = new Scale();
    	oldScale.setPivotX(100);
    	oldScale.setPivotY(100);
    	oldScale.setX(2);
    	oldScale.setY(2);
    	a.getTransforms().add(oldScale);
    }
